...
CREATE TABLE `seguidores` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `seguidores_ibfk_1` FOREIGN KEY (`id_artista`) REFERENCES `artistas` (`id_artista`),
  CONSTRAINT `seguidores_ibfk_2` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_siguiendo` AFTER INSERT ON `seguidores` FOR EACH ROW BEGIN
